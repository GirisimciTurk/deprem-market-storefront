          ...
          <div className="grid">
            <div className="flex flex-col">
              ...
              <span className="mb-4 text-ui-fg-muted txt-medium">
                Siparişiniz nasıl teslim edilsin?
              </span>
            </div>
                        ...
                        <div className="flex items-center gap-x-4">
                          ...
                          <div className="flex flex-col">
                            <span className="text-base-semi font-semibold text-ui-fg-base">
                              {option.name === "Standart Kargo"
                                ? "Yurtiçi Kargo"
                                : option.name === "Hızlı Kargo"
                                ? "MNG Kargo (Hızlı)"
                                : option.name}
                            </span>
                            <span className="text-xs text-ui-fg-muted">
                              {option.name === "Standart Kargo"
                                ...
                                : option.name === "Hızlı Kargo"
                                ? "Tahmini Teslimat: Ertesi Gün (1 İş Günü)"
                                : "2-3 İş Günü"}
                            </span>
                          </div>
                        </div>
          ...
          {showPickupOptions === PICKUP_OPTION_ON && (
            <div className="grid">
              <div className="flex flex-col">
                ...
                <span className="mb-4 text-ui-fg-muted txt-medium">
                  Yakınınızdaki bir mağaza seçin
                </span>
              </div>
              <div data-testid="delivery-options-container">
                <div className="pb-8 md:pt-0 pt-2">
            ...
            {cart && (cart.shipping_methods?.length ?? 0) > 0 && (
              <div className="flex flex-col w-1/3">
                ...
                <Text className="txt-medium text-ui-fg-subtle">
                  {cart.shipping_methods!.at(-1)!.name === "Standart Kargo"
                    ? "Yurtiçi Kargo (2-3 İş Günü)"
                    : cart.shipping_methods!.at(-1)!.name === "Hızlı Kargo"
                    ? "MNG Kargo (1 İş Günü)"
