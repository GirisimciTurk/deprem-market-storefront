        ...
        <div className="my-6 p-4 border border-ui-border-base rounded-lg bg-ui-bg-subtle transition-all duration-300">
          <div className="flex justify-between items-center mb-4">
            ...
            {cardBrand !== "Bilinmeyen" && (
              <span className="text-xs px-2 py-1 bg-rose-50 border border-rose-200 text-rose-700 rounded-md font-semibold">
                {cardBrand}
              </span>
            )}
          </div>
          <div className="flex flex-col gap-y-3">
            <div>
              ...
              <input
                ...
                className="w-full h-10 px-3 border border-ui-border-base rounded-md focus:outline-none focus:border-rose-500 text-sm bg-white"
              />
            </div>
            <div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="text-ui-fg-subtle hover:text-rose-600 p-1.5 rounded-full hover:bg-rose-50 transition-colors"
                          title="Kartı Sil"
                        >
