      ...
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-sm p-8 small:p-10">
        ...
        {!linkValid ? (
          <div className="text-center">
            ...
            <LocalizedClientLink href="/account" className="text-brand-600 font-bold text-sm hover:underline">
              Girişe dön
            </LocalizedClientLink>
          </div>
        ) : done ? (
          <div className="text-center">
            ...
            <LocalizedClientLink
              href="/account"
              className="inline-block bg-brand-600 hover:bg-brand-700 text-white font-bold py-2.5 px-7 rounded-lg text-sm transition-colors"
            >
              Giriş Yap
            </LocalizedClientLink>
          </div>
          ...
          <>
            ...
            <div className="text-center mt-6">
              <LocalizedClientLink href="/account" className="text-xs text-gray-500 hover:text-brand-600 font-semibold">
                Girişe dön
              </LocalizedClientLink>
            </div>
          </>
