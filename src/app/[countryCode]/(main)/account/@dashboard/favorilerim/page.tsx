              ...
              <div className="flex flex-col justify-between flex-1 min-w-0">
                <div>
                  <LocalizedClientLink href={`/products/${item.handle}`}>
                    <h3 className="font-bold text-ui-fg-base text-sm sm:text-base truncate group-hover:text-brand-655 transition-colors hover:text-brand-600">
                      {item.title}
                    </h3>
                  </LocalizedClientLink>
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="border border-ui-border-base hover:bg-brand-50 hover:text-brand-700 text-ui-fg-subtle p-2 rounded-lg transition-colors text-xs"
                    ...
                    <button
                      ...
                      className="bg-brand-600 hover:bg-brand-700 text-white font-bold px-3 py-1.5 rounded-lg text-xs transition-colors shadow-sm"
                    >
                      Sepete Ekle
                    </button>
                  </div>
